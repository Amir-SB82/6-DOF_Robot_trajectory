...
extern prev_pos;
extern COUNT;
extern float m1,m2,m3,m4,m5,m6;
extern int i,j,motor1,motor2,motor3,motor4,motor5,motor6;
extern const float datatest[2678][6];
extern float datatestpulse[2678][6];
extern vel;
